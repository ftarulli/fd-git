...
<MDBContainer fluid className='d-flex justify-content-center align-items-center text-center mt-5' style={{ backgroundColor: 'orange', padding: '0.5px', maxWidth: '80%', margin: 'auto', border: '0px solid black' }}>
</MDBContainer>
...
{/* Derechos de autor */}
<MDBContainer fluid className='d-flex justify-content-center align-items-center text-center mt-5' style={{ backgroundColor: 'orange', padding: '10px 20px', maxWidth: '100%', margin: 'auto' }}>
  <MDBRow className='mt-3'>
    <MDBCol md='12' lg='12' xl='12' className='mx-auto mb-4'>
      <p className='text-white' style={{ margin: '0' }}>
        ...
        <a href='https://www.linkedin.com/in/vaninabalbastro/' className='text-white footer-link'>Vanina Balbastro</a>,{' '}
        <a href='https://www.linkedin.com/in/lourdes-billone/' className='text-white footer-link'>Lourdes Billone</a>,{' '}
